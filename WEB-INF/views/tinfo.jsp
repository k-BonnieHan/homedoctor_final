			...
			<div class="editor-wrap">
				<nav>
					<ul class="nav-container">
						<li class="nav-item"><a href="tpboard_insert">홈닥터 서비스
								바로가기</a></li>
						<li class="nav-item"><a href="appoint">온라인 예약 서비스 바로가기</a></li>
					</ul>
				</nav>
				<h1 class="editor-tit">전화예약</h1>
				<ul>
				...
				<h1 class="editor-tit">전화/ 온라인 예약 시 유의 사항</h1>
				<ul>
				...
				<h1 class="editor-tit">외래 접수·수납 예약 및 진료시간</h1>
				<div style="float: left; margin-left: 20px">
				<table class="responsive-table" style="width: 600px" border="1">
